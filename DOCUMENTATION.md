...
```
<yourname>/
├── PERSONA_<yourname>_GLOBAL.md   ← your voice, style, how you work (built by /create-persona)
...
Your own files (personas you built, plans, trackers, projects) are never touched by sync.
